...
public class PublicEventController {
    ...
    public ResponseEntity<Void> likeEvent(
            ...
            @RequestHeader("X-EWM-USER-ID") long userId) {
        List<ParticipationRequestDto> requests = requestClient.getEventParticipants(userId, eventId);
        boolean hasConfirmedRequest = requests.stream()
                .anyMatch(r -> "CONFIRMED".equals(r.getStatus()));
